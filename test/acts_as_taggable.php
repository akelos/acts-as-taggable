...
$test = &new GroupTest('Acts As Taggable Plugin Unit Tests');

$test->addTestFile(AK_TEST_DIR.DS.'unit'.DS.'lib'.DS.'ActsAsTaggableTest.php');
$test->addTestFile(AK_TEST_DIR.DS.'unit'.DS.'app'.DS.'models'.DS.'tag_list_test.php');
$test->addTestFile(AK_TEST_DIR.DS.'unit'.DS.'app'.DS.'models'.DS.'tag_cloud_test.php');
